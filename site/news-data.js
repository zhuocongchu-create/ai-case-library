...
window.NEWS=[
  {
    ...
    items:[
      {
        title:"美国指控中国AI公司知识提取，合规成本或成新赛道竞争关键",
        why:"美国NSA等机构指控六家中国AI公司违规提取知识，争议核心在访问授权。想做AI副业的，别被‘蒸馏合法’忽悠，合规成本可能比技术更重要——尤其在跨境合作中，直接避开争议领域更稳妥。",
        url:"https://x.com/thexpin/status/2097615997616406833",
        tag:"行业观察"
      },
      {
        title:"美军秘密合同要求AI模型最低拒绝率，定制化需求或成高溢价",
        why:"五角大楼曾要求OpenAI提供军事指令专用模型，且律师多次改口确认文件真实性。想接AI单的，别只看技术，安全合规是军方客户的核心考量——先做小规模测试再谈合作，避免因伦理争议损失大单。",
        url:"https://www.ithome.com/1/000/277.htm",
        tag:"行业观察"
      },
      {
        title:"OpenAI安全委员会添伦理专家，AI合规门槛或提升",
        why:"Paul Christiano加入OpenAI安全治理层，暗示AI伦理审查趋严。想做AI副业的，得提前布局安全治理模块——否则可能失去高价值企业客户，尤其是对数据敏感的行业。",
