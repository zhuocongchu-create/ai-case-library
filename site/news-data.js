...
window.NEWS=[
  {
    ...
    items:[
      {
        title:"美国三部门指控六家中国AI公司违规提取模型数据",
        why:"美国机构点名DeepSeek等六家中国AI公司涉数据合规争议，提醒想做AI副业的你：知识蒸馏技术存在法律风险，尤其涉及跨境数据时需谨慎。建议优先选择本地合规模型，或通过代理服务规避直接接触敏感数据，避免被卷入国际纠纷。",
        url:"https://x.com/thexpin/status/2097615997616406833",
        tag:"行业观察"
      },
      {
        title:"美军曾要求OpenAI定制低拒率军事AI模型",
        why:"国防部合同草案暴露AI军事化需求，想接AI单的你需警惕特殊场景定制风险。注意：军方对模型安全护栏要求严苛，类似需求可能隐藏高额合规成本。建议优先接民用领域订单，或深入研究安全评估标准提升报价空间。",
        url:"https://www.ithome.com/1/000/277.htm",
        tag:"行业观察"
      },
      {
        title:"Paul Christiano强化OpenAI安全治理架构",
        why:"安全委员会新成员Paul Christiano暗示OpenAI将加强AI伦理审查，想做AI副业的你需注意：安全合规已成为行业标配，建议提前学习安全评估框架，为定制化服务打造差异化竞争力，避免被工具取代。",
